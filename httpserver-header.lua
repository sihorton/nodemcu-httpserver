...
return function (connection, code, extension)
   ...
   local function getMimeType(ext)
      ...
      local mt = {css = "text/css", gif = "image/gif", htm = "text/html", ico = "image/x-icon", jpeg = "image/jpeg", jpg = "image/jpeg", js = "application/javascript", json = "application/json", png = "image/png", xml = "text/xml"}
